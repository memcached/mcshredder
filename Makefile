...
tls:
		cd vendor/ && ${MAKE}
		# sometimes helpful to add -fno-omit-frame-pointer for perf tracing
		gcc -g -O0 -pthread -rdynamic -Ivendor/lua/src -Ivendor/liburing/src/include -Wall -pedantic -o mcshredder mcshredder.c tls.c itoa_ljust.c vendor/mcmc/mcmc.o vendor/lua/src/liblua.a vendor/liburing/src/liburing.a -lcrypto -lssl -lm $(LDFLAGS) -ldl
